    ...
    <div className={styles.projectPage}>
      <div className={styles.projectPageBody}>
        <div className={styles.projectContainer}>
          <a className={styles.projectA} href="//hexproof.club" target="_blank" rel="noopener noreferrer" >
        ...
        <div className={styles.projectContainer}>
          <a className={styles.projectA} href="//shredder-29fbd.firebaseapp.com" target="_blank" rel="noopener noreferrer" >
