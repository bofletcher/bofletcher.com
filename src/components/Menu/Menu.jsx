   ...
   <div className={attachedStyles.join(' ')}>
    <div className={styles.startMenuWrapper}>
      <div className={styles.startMenuSideTextWRow}>
        ...
        <Link to="/projects">
          <div onClick={()=> {props.openWindow('PROJECTS'); props.click()}} className={styles.startMenuOption}>
          ...
          <Link to="/resume">
          <div onClick={()=> {props.openWindow('RESUME'); props.click()}} className={styles.startMenuOption}>
          ...
          <Link to="/about">
          <div onClick={()=> {props.openWindow('ABOUT'); props.click()}} className={styles.startMenuOption}>
          ...
          <Link onClick={()=> {props.openWindow('CONTACT'); props.click()}} to="/contact">
